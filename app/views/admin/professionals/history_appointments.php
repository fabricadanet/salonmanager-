        ...
        <?php else: ?>
            <?php foreach ($appointments as $app): ?>
                <tr class="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-xs font-black text-slate-900 uppercase tracking-tighter"><?= htmlspecialchars($app['customer_name']) ?></td>
                    <td class="px-6 py-4 text-xs text-gray-500"><?= htmlspecialchars($app['service_name']) ?></td>
                    <td class="px-6 py-4">
