<div x-data="{ 
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 space-y-4 md:space-y-0">
        <div>
            <h2 class="text-3xl font-bold text-slate-900 tracking-tighter uppercase">Clientes</h2>
            <p class="text-xs text-gray-400 uppercase tracking-[0.3em] font-bold mt-1">Gestão de Base de Dados</p>
        </div>
        <a href="/admin/customers/create" class="bg-slate-900 hover:bg-slate-800 text-white px-8 py-3 rounded-none shadow-sm text-[10px] font-black uppercase tracking-[0.2em] transition-all hover:scale-[1.02] active:scale-[0.98]">
            + Novo Cliente
        </a>
    </div>
    ...
    <div class="bg-white p-6 mb-6 shadow-sm border border-gray-100">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="md:col-span-2">
                ...
                <div class="relative">
                    <input type="text" x-model.debounce.500ms="search" placeholder="Digite o nome do cliente..." 
